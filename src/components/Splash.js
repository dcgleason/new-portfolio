          ...
          <div className="row">
            ...
            <div className="col-lg-12 text-center typewriter">
              ...
              <p className="typewriter">
                Full Stack Engineer <br/> <a className="resume" href="https://docs.google.com/document/d/1fliqkVw-Dl5DH0lNOvzOcoEvW8gz_ChUBTg0QFZFVLg/edit?usp=sharing" target="_blank"> My Resume</a>
              </p>
              <p>
